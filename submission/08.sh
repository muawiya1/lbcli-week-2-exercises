...
bitcoin-cli -regtest createrawtransaction '''[{"txid":"'$utxo_txid'","vout":'$utxo_vout_1'},{"txid":"'$utxo_txid'","vout":'$utxo_vout_2'}]''' '''{"'2MvLcssW49n9atmksjwg2ZCMsEMsoj3pzUP'":0.23659108}'''